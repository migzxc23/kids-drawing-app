...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * After granting permission, next line is accessing the media storage.
     */
    ...
    /**
     * method to take care request storage permission
     */
    private fun requestStoragePermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(
                this,
                Manifest.permission.READ_EXTERNAL_STORAGE)){
            showRationaleDialog("Kids Drawing App", "Kids Drawing App " + "needs access to your external storage.")
        }
        else{
...
//        Toast.makeText(this, "Clicked Gallery", Toast.LENGTH_LONG).show()
    ...
    /**
     * display alert dialog with builder
     */
    ...
    private suspend fun saveBitmapFile(mBitMap: Bitmap?): String {
        /**
         * Code block sample on how to run process in background thread.
         */
        ...
        withContext(Dispatchers.IO){
            if(mBitMap != null){
                try{
                    ...
                    /**
                     * CODE BLOCK ON HOW TO RUN THE PROCESS IN UI THREAD
                     */
                    runOnUiThread{
